    ...
    <div>
      ...
      <div className="flex flex-col items-center px-4 md:px-16">
        ...
        <div
          id="marketing-banner"
          tabIndex={-1}
          className="fixed z-50 flex flex-col-reverse gap-y-4 items-center md:flex-row justify-between w-[calc(100%-2rem)] p-4 -translate-x-1/2 bg-white border border-gray-100 rounded-lg shadow-sm lg:max-w-7xl left-1/2 bottom-10 dark:bg-gray-700 dark:border-gray-600"
        >
          <div className="flex flex-col-reverse md:gap-x-4 mb-3 me-4 items-center md:flex-row md:mb-0">
            ...
            <p className="flex items-center text-md font-normal text-center text-gray-800 dark:text-gray-400">
          ...
          <div className="w-full md:w-fit flex justify-center items-center md:gap-x-4">
            ...
            <button
              ...
              type="button"
              className="flex-shrink-0 inline-flex justify-center w-7 h-7 items-center text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 dark:hover:bg-gray-600 dark:hover:text-white ml-auto"
            >
              <svg
                className="w-3 h-3"
                aria-hidden="true"
        ...
        {/* Card Result */}
        <div className="mt-0 md:mt-8 flex flex-col md:flex-row gap-4 w-full lg:w-1/2 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 px-4">
            ...
            <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
                ...
                <blockquote className="flex flex-col gap-y-4 rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                  ...
                  <p className="mt-4 text-gray-700">
                    Hubungi petugas kesehatan untuk melakukan penyemprotan di sekitar rumah Anda
                  </p>
                  <a
                ...
                <blockquote className="flex flex-col gap-y-4 rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                  ...
                  <p className="mt-4 text-gray-700">
                    Larutkan bubuk abate di tempat-tempat yang berpotensi menjadi tempat berkembang biak nyamuk
                  </p>
                  <a
